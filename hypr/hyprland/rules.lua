...
hl.window_rule({ name = "music",         workspace = "special:music",   match = { class = "feishin|Spotify|Supersonic|Cider|spotify" } })
...
hl.window_rule({ name = "communication", workspace = "special:communication", match = { class = "discord|equibop|vesktop|whatsapp|org.telegram.desktop|Slack" } })
...
-- ── Dialogs ───────────────────────────────────────────────────────────────────
-- Hyprland doesn't expose transient_for to Lua; title heuristics cover
-- GTK/Qt file choosers and similar dialogs that open as independent toplevels.
...
hl.layer_rule({ name = "caelestia-no-anim",   no_anim   = true,         match = { namespace = "caelestia-(border-exclusion|area-picker)" } })
hl.layer_rule({ name = "caelestia-fade",      animation = "fade",       match = { namespace = "caelestia-(drawers|background)" } })
hl.layer_rule({ name = "caelestia-blur",      blur = true, ignore_alpha = 0.57, match = { namespace = "caelestia-drawers" } })
