...
hl.bind("SUPER + J",           hl.dsp.global("caelestia:showall"))
...
for i = 1, 9 do
  hl.bind("SUPER + " .. i,        function() v.ws_goto(i) end)
  hl.bind("CTRL + SUPER + " .. i, function() v.ws_goto_group(i) end)
end
hl.bind("SUPER + 0",        function() v.ws_goto(10) end)
hl.bind("CTRL + SUPER + 0", function() v.ws_goto_group(10) end)
...
for i = 1, 9 do
  hl.bind("SUPER + ALT + " .. i,        function() v.ws_move(i) end)
  hl.bind("CTRL + SUPER + ALT + " .. i, function() v.ws_move_group(i) end)
end
hl.bind("SUPER + ALT + 0",        function() v.ws_move(10) end)
hl.bind("CTRL + SUPER + ALT + 0", function() v.ws_move_group(10) end)
...
-- resizeactive exact 55% 70% has no direct Lua API (needs numeric px); fall back to hyprctl
hl.bind("CTRL + SUPER + ALT + backslash", hl.dsp.exec_cmd("hyprctl dispatch resizeactive exact 55% 70%"))
